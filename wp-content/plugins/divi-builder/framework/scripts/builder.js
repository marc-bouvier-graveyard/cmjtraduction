	...
	$( document ).ready( function() {
		...
		et_builder = {
			...
			options_tabs_output: function( options ){
				...
				window.et_builder_template_options = { tabs : {options} };
			...
			options_padding_output: function( options ){
				...
				window.et_builder_template_options = { padding : {options} };
			...
			options_yes_no_button_output: function( options ){
				...
				window.et_builder_template_options = { yes_no_button : {options} };
			...
			options_font_buttons_output: function( options ){
				...
				window.et_builder_template_options = { font_buttons : {options} };
